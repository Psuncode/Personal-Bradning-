...
human_verification:
  ...
  - test: "Visit photography.philipsun.com/pricing in a browser"
    expected: "Three pricing cards render with dollar amounts: $250 (Portrait Session), $600 (Event Coverage), $400 (Landscape Half-Day). No 'contact for pricing' text is visible."
    why_human: "Pricing page is a Server Component — data rendering correctness requires a live browser visit to confirm JSX output."
